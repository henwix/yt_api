...
@extend_schema_view(
    ...
    list=extend_schema(summary='Get list of video reports'),
    retrieve=extend_schema(summary='Retrieve video report'),
    destroy=extend_schema(summary='Delete video report'),
)

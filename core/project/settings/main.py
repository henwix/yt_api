...
FRONTEND_PROTOCOL = os.environ.get('FRONTEND_PROTOCOL', 'https')
FRONTEND_DOMAIN = os.environ.get('FRONTEND_DOMAIN', 'example.com')

FRONTEND_PASSWORD_RESET_URI = os.environ.get('FRONTEND_PASSWORD_RESET_URI')
FRONTEND_USERNAME_RESET_URI = os.environ.get('FRONTEND_USERNAME_RESET_URI')
FRONTEND_ACTIVATE_URI = os.environ.get('FRONTEND_ACTIVATE_URI')
FRONTEND_PAYMENT_SUCCESS_URI = os.environ.get('FRONTEND_PAYMENT_SUCCESS_URI')
FRONTEND_PAYMENT_CANCEL_URI = os.environ.get('FRONTEND_PAYMENT_CANCEL_URI')
